...
public class ExperimentRunnerTest {
    ...
    public void testExperimentRunner() {
        ...
        OurExperimentRunner<KnapsackProblem.KnapsackNode> er = new OurExperimentRunner<KnapsackProblem.KnapsackNode>(search, solutionEvaluator);
    ...
    public void testAWAStar() {
        ...
        try {
            ...
            OurExperimentRunnerAWAStar er = new OurExperimentRunnerAWAStar(awaStarSearch, knapsackProblem.getSolutionEvaluator());
            OurExperimentRunnerAWAStar.execute(er, TIMEOUT);
            System.out.println(er.getBestSolution());
            System.out.println(er.isNoNextSolution());
